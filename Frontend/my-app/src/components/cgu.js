    ...
    return (
        <div className='box'>
            <div className='CGU'>
                ...
                <p>
                    Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique de l’utilisation du site SafeVote et de ses services.
                ...
                <p>Pour les personnes morales :
                    ...
                    Le site SafeVote est édité par la société Efrei Paris.


                    Pour les personnes physiques :

                    Le site SafeVote est édité par Le Corvec Malo et Keunebroek Baptiste.
                </p>

                <h3> ARTICLE 3 : accès aux services</h3>
                <p>
                    L’Utilisateur du site SafeVote a accès aux services suivants :
                ...
                <p>
                    ...
                    L’Utilisateur assume l’entière responsabilité de l’utilisation qu’il fait des informations et contenus présents sur le site SafeVote
                ...
                <p>
                    ...
                    Les contenus du site SafeVote (logos, textes, éléments graphiques, vidéos, etc.) sont protégés par le droit d’auteur, en vertu du Code de la propriété intellectuelle.
                ...
                <p>
                    ...
                    L’adresse électronique (e-mail) de l’utilisateur pourra notamment être utilisée par le site SafeVote pour la communication d’informations diverses et la gestion du compte.

                    SafeVote garantie le respect de la vie privée de l’utilisateur, conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.


                    En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles
                </p>
                <h3> ARTICLE 8 : Liens hypertextes</h3>
                <p>

                    Les domaines vers lesquels mènent les liens hypertextes présents sur le site n’engagent pas la responsabilité de l’Éditeur de SafeVote, qui n’a pas de contrôle sur ces liens.

                    Il est possible pour un tiers de créer un lien vers une page du site SafeVote sans autorisation expresse de l’éditeur.
                </p>

                <h3> ARTICLE 9 : Évolution des conditions générales d’utilisation</h3>
                <p>

                    Le site SafeVote se réserve le droit de modifier les clauses de ces conditions générales d’utilisation à tout moment et sans justification.
                ...
                <p>
                    ...
                    En cas de litige non résolu à l’amiable entre l’Utilisateur et l’Éditeur, les tribunaux de Villejuif sont compétents pour régler le contentieux.
